      ...
      <nav id="main-nav" className="fixed top-0 left-0 right-0 z-[100] transition-all duration-300">
        <div className="container mx-auto px-6 py-4">
          <div className="glass rounded-full px-6 py-3 flex items-center justify-between">
            <a href="#hero" className="text-xl font-display font-bold text-white hover:text-accent transition flex items-center gap-2">
              <span>SIRAQ</span>
            </a>
            <div className="hidden lg:flex items-center gap-6">
              ...
              <a href="/students" className="nav-link text-sm font-semibold text-cyan-400 hover:text-cyan-300 transition flex items-center gap-1">
                <span>Students Portal</span>
              </a>
              <a href="/admin" className="nav-link text-sm font-semibold text-amber-400 hover:text-amber-300 transition flex items-center gap-1">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="/students" className="px-3.5 py-1.5 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 text-xs font-semibold hover:bg-cyan-500/30 transition">
                Students
              </a>
              <a href="/admin" className="px-3.5 py-1.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30 text-xs font-semibold hover:bg-amber-500/30 transition">
                Admin
              </a>
            </div>
            <button id="mobile-menu-btn" className="lg:hidden text-white focus:outline-none" aria-label="Toggle menu">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path>
              </svg>
            </button>
          </div>
          <div id="mobile-menu" className="hidden lg:hidden mt-4 glass rounded-3xl p-6">
            <div className="flex flex-col gap-4">
              <a href="#hero" className="mobile-nav-link text-sm font-medium text-slateSoft hover:text-white transition">Home</a>
              <a href="/students" className="mobile-nav-link text-sm font-bold text-cyan-400 hover:text-cyan-300 transition">🎓 Students Portal</a>
              <a href="/admin" className="mobile-nav-link text-sm font-bold text-amber-400 hover:text-amber-300 transition">🔐 Admin Portal</a>
      ...
      <main className="relative z-10">
          ...
          <div className="w-full max-w-5xl mx-auto text-center">
            <div className="text-center">
              ...
              <div className="mt-10 flex flex-wrap gap-4 justify-center items-center">
                <a
                  href="/students"
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 to-teal-400 px-8 py-4 text-sm font-bold uppercase tracking-wider text-black shadow-lg shadow-cyan-500/20 transition hover:-translate-y-1 hover:shadow-cyan-500/40 hover:scale-105"
                >
                  🎓 Students Portal
                </a>
                <a
                  href="/admin"
                  className="inline-flex items-center gap-2 rounded-full bg-slate-800 hover:bg-slate-700 border border-slate-700 px-8 py-4 text-sm font-bold uppercase tracking-wider text-amber-400 transition hover:-translate-y-1 hover:scale-105"
                >
                  🔐 Admin Portal
                </a>
                <a
                  href="#services"
                  className="inline-block rounded-full bg-gradient-to-r from-accent to-neon px-8 py-4 text-sm font-semibold uppercase tracking-wider text-charcoal shadow-glow transition hover:-translate-y-1 hover:shadow-[0_25px_50px_rgba(249,178,52,0.4)] hover:scale-105"
                >
                  Services
                </a>
              </div>
        ...
        <footer id="contact" className="border-t border-white/10 bg-space/70 py-10">
          <div className="container mx-auto px-6">
            ...
            <div className="mt-6 flex flex-wrap justify-center items-center gap-4 border-t border-white/10 pt-6 text-xs text-slateSoft">
              <a href="/students" className="text-cyan-400 font-semibold transition hover:text-cyan-300">Students Portal</a>
              <span>•</span>
              <a href="/admin" className="text-amber-400 font-semibold transition hover:text-amber-300">Admin Portal</a>
              <span>•</span>
